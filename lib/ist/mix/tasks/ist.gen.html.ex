defmodule Mix.Tasks.Ist.Gen.Html do
  @shortdoc "Generates controller, views, and context for an HTML resource"

  @moduledoc """
  Generates controller, views, and context for an HTML resource.

      mix ist.gen.html Accounts User users name:string age:integer
  ...
  Alternatively, the `--context-app` option may be supplied to the generator:
      ...
      mix ist.gen.html Sales User users --context-app warehouse
  ...
  module name, for example:
      ...
      mix ist.gen.html Sales User users --web Sales
  ...
  a `--table` option may be provided. For example:
      ...
      mix ist.gen.html Accounts User users --table cms_users
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise("mix ist.gen.html can only be run inside an application directory")
    end
  ...
  def copy_new_files(%Context{} = context, paths, binding) do
    ...
    Mix.Phoenix.copy_from(paths, "priv/templates/ist.gen.html", binding, files)
