defmodule Mix.Tasks.Ist.Gen.Schema do
  @shortdoc "Generates an Ecto schema and migration file"

  @moduledoc """
  Generates an Ecto schema and migration.

      mix ist.gen.schema Blog.Post blog_posts title:string views:integer
  ...
  the CLI.
      ...
      # Via CLI
      mix ist.gen.schema Blog.Post blog_posts title:string views:integer --context-app marketing
  ...
  the type makes it default to `:string`:
      ...
      mix ist.gen.schema Blog.Post blog_posts title views:integer
  ...
  referenced table:
      ...
      mix ist.gen.schema Blog.Post blog_posts title user_id:references:users
  ...
  type of the underlying array element to be given too:
      ...
      mix ist.gen.schema Blog.Post blog_posts tags:array:string

  Unique columns can be automatically generated by using:

      mix ist.gen.schema Blog.Post blog_posts title:unique unique_int:integer:unique
  ...
  a `--table` option may be provided. For example:
      ...
      mix ist.gen.schema Blog.Post posts --table cms_posts
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise("mix ist.gen.schema can only be run inside an application directory")
    end
  ...
  def copy_new_files(%Schema{context_app: ctx_app} = schema, paths, binding) do
    ...
    Mix.Phoenix.copy_from(paths, "priv/templates/ist.gen.schema", binding, files)
    ...
    if schema.migration? do
      ...
      Mix.Phoenix.copy_from(paths, "priv/templates/ist.gen.schema", binding, [
  ...
  def raise_with_help(msg) do
    ...
    mix ist.gen.schema expects both a module name and
    the plural of the generated resource followed by
    any number of attributes:

        mix ist.gen.schema Blog.Post blog_posts title:string
    """)
  end
